...
const Roadmap = () => {
  ...
  return (
    <section className="px-6 py-12 md:px-20 bg-gray-900 w-full">
      <div className="flex items-center gap-3 mb-6">
        <HiLightningBolt className="text-yellow-500 w-7 h-7" />
        <h2 className="text-3xl font-bold text-white">My Roadmap</h2>
      </div>
      
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {roadmapItems.map((item, index) => (
          <div key={index} className="bg-gray-800 shadow-md rounded-xl p-6 transition-all duration-300 hover:shadow-lg">
      ...
      <div className="mt-6 bg-gray-800 shadow-md rounded-xl p-6 transition-all duration-300">
